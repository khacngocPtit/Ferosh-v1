            ...
            <nav class="navbar navbar-expand-lg navbar-light">
              ...
              <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav mr-auto">
                        ...
                        <div class="row">
                          <div class="col-md-2">
                            ...
                            <ul>
                              ...
                              <li class=""><a href="#" class="d-block">&Aacute;o</a></li>
                              <li class=""><a href="#" class="d-block">Vali</a></li>
                              <li class=""><a href="#" class="d-block">Đồng hồ</a></li>
                              <li class=""><a href="#" class="d-block">D&eacute;p</a></li>
                              <li class=""><a href="#" class="d-block">T&uacute;i Balo</a></li>
                              <li class=""><a href="#" class="d-block">B&ocirc;ng tai</a></li>
                              <li class=""><a href="#" class="d-block">Nhẫn</a></li>
                              <li class=""><a href="#" class="d-block">Bộ trang sức</a></li>
                              <li class=""><a href="#" class="d-block">&Aacute;o d&agrave;i</a></li>
                              <li class=""><a href="#" class="d-block">&Aacute;o kho&aacute;c</a></li>
                              <li class=""><a href="#" class="d-block">Bộ</a></li>                             
                  ...
                  <li class="nav-item bg-red">
                    <a class="nav-link" href="#">CRAZY SALE</a>
                  </li>
                  <li class="nav-item">
                        ...
                        <div class="row">
                          <div class="col-md-2">
                            ...
                            <ul>
                              ...
                              <li><a href="#" class="d-block">Tuần n&agrave;y</a></li>
                              <li><a href="#" class="d-block">Tuần trước</a></li>
                              <li><a href="#" class="d-block">Nh&agrave; thiết kế mới</a></li>
                            </ul>
                          </div>
                          <div class="col-md-10">
                   ...
                   <li class="nav-item">
                    <a class="nav-link" href="#">GIÀY & PHỤ KIỆN</a>
                    <div class="sub-menu" style="display: none;">
                      <div class="container">
                        <h3 class="heading back">Back</h3>
                        <span class="line-break"></span>
                  ...
                  <li class="nav-item">
                    <a class="nav-link" href="#">NHÀ THIẾT KẾ</a>
